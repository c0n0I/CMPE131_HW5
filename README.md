...
Pytest discover is a testing framework that identifies and collect test files, functions, and classes within a project. It finds and runs tests based on naming convention. For example, test files must be named _test_*.py_ or _*_test.py_ and test functions must be named _test..._.
